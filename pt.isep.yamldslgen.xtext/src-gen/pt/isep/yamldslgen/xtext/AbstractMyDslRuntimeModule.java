 ...
 */
package pt.isep.yamldslgen.xtext;
...
import pt.isep.yamldslgen.xtext.formatting2.MyDslFormatter;
import pt.isep.yamldslgen.xtext.generator.MyDslGenerator;
import pt.isep.yamldslgen.xtext.parser.antlr.MyDslAntlrTokenFileProvider;
import pt.isep.yamldslgen.xtext.parser.antlr.MyDslParser;
import pt.isep.yamldslgen.xtext.parser.antlr.internal.InternalMyDslLexer;
import pt.isep.yamldslgen.xtext.scoping.MyDslScopeProvider;
import pt.isep.yamldslgen.xtext.serializer.MyDslSemanticSequencer;
import pt.isep.yamldslgen.xtext.serializer.MyDslSyntacticSequencer;
import pt.isep.yamldslgen.xtext.services.MyDslGrammarAccess;
import pt.isep.yamldslgen.xtext.validation.MyDslConfigurableIssueCodesProvider;
import pt.isep.yamldslgen.xtext.validation.MyDslValidator;
...
public abstract class AbstractMyDslRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "pt/isep/yamldslgen/xtext/MyDsl.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("pt.isep.yamldslgen.xtext.MyDsl");
	}
