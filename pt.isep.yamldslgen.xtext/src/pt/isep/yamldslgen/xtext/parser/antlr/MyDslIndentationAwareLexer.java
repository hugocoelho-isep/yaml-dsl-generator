...
public class MyDslIndentationAwareLexer extends InternalMyDslLexer {
	...
	public Token nextToken() {
		...
		// (7) Dash at start of a line: opens a virtual block for the item's
	...
	private Token makeSynthetic(int type, String text) {
		...
		// Use the CharStream's position so line/column reflect the actual
		// place in the document, not the lexer's internal token-start state.
