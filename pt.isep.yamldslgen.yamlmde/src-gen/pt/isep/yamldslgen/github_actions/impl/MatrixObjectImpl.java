...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Matrix Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link pt.isep.yamldslgen.github_actions.impl.MatrixObjectImpl#getInclude <em>Include</em>}</li>
 *   <li>{@link pt.isep.yamldslgen.github_actions.impl.MatrixObjectImpl#getExclude <em>Exclude</em>}</li>
 *   <li>{@link pt.isep.yamldslgen.github_actions.impl.MatrixObjectImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MatrixObjectImpl extends MatrixImpl implements MatrixObject {
	/**
	...
	protected EClass eStaticClass() {
		return YamlmdePackage.Literals.MATRIX_OBJECT;
	}
	...
	public EList<Include> getInclude() {
		if (include == null) {
			include = new EObjectContainmentEList<Include>(Include.class, this, YamlmdePackage.MATRIX_OBJECT__INCLUDE);
		}
		return include;
	}
	...
	public EList<Exclude> getExclude() {
		if (exclude == null) {
			exclude = new EObjectContainmentEList<Exclude>(Exclude.class, this, YamlmdePackage.MATRIX_OBJECT__EXCLUDE);
		}
		return exclude;
	}
	...
	public EList<MatrixParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<MatrixParameter>(MatrixParameter.class, this,
					YamlmdePackage.MATRIX_OBJECT__PARAMETERS);
		}
		return parameters;
	}
