 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.yamldslgen.github_actions.impl.RunImpl#getShell <em>Shell</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RunImpl extends MinimalEObjectImpl.Container implements Run {
	...
	protected EClass eStaticClass() {
		return YamlmdePackage.Literals.RUN;
	}
	...
	public void setShell(String newShell) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, YamlmdePackage.RUN__SHELL, oldShell, shell));
	}
