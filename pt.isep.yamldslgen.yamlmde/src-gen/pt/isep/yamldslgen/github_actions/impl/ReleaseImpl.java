 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.yamldslgen.github_actions.impl.ReleaseImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ReleaseImpl extends MinimalEObjectImpl.Container implements Release {
	...
	protected EClass eStaticClass() {
		return YamlmdePackage.Literals.RELEASE;
	}
	...
	public EList<String> getTypes() {
		if (types == null) {
			types = new EDataTypeUniqueEList<String>(String.class, this, YamlmdePackage.RELEASE__TYPES);
		}
		return types;
	}
