 ...
 * @generated
 */
public class Workflow_callImpl extends MinimalEObjectImpl.Container implements Workflow_call {
	/**
	...
	protected EClass eStaticClass() {
		return YamlmdePackage.Literals.WORKFLOW_CALL;
	}
	...
	public EList<Secret> getSecrets() {
		if (secrets == null) {
			secrets = new EObjectContainmentEList<Secret>(Secret.class, this, YamlmdePackage.WORKFLOW_CALL__SECRETS);
		}
		return secrets;
	}
