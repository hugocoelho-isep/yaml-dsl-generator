...
/**
 * This is the item provider adapter for a {@link pt.isep.yamldslgen.docker_compose.Config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConfigItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addSubnetPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Config_subnet_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Config_subnet_feature", "_UI_Config_type"),
						DockercomposePackage.Literals.CONFIG__SUBNET, true, false, false,
	...
	public String getText(Object object) {
		String label = ((Config) object).getSubnet();
	...
	public void notifyChanged(Notification notification) {
		...
		case DockercomposePackage.CONFIG__SUBNET:
