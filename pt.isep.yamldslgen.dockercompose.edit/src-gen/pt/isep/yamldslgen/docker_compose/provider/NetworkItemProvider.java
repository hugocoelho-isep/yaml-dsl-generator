...
/**
 * This is the item provider adapter for a {@link pt.isep.yamldslgen.docker_compose.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Network_id_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Network_id_feature", "_UI_Network_type"),
						DockercomposePackage.Literals.NETWORK__ID, true, false, false,
	...
	protected void addDriverPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Network_driver_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Network_driver_feature",
								"_UI_Network_type"),
						DockercomposePackage.Literals.NETWORK__DRIVER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIpv4AddressPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Network_ipv4Address_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Network_ipv4Address_feature",
								"_UI_Network_type"),
						DockercomposePackage.Literals.NETWORK__IPV4_ADDRESS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
