...
public class InternalMyDslLexer extends Lexer {
    ...
    public final void mRULE_BEG_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20580:16: ( 'synthetic:BEGIN' )
            // InternalMyDsl.g:20580:18: 'synthetic:BEGIN'
            {
    ...
    public final void mRULE_END_BLOCK() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20582:16: ( 'synthetic:END' )
            // InternalMyDsl.g:20582:18: 'synthetic:END'
            {
            match("synthetic:END"); 
    ...
    public final void mRULE_SQ_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20584:16: ( '\\'' (~ ( '\\'' ) )* '\\'' )
            // InternalMyDsl.g:20584:18: '\\'' (~ ( '\\'' ) )* '\\''
            {
            match('\''); 
            // InternalMyDsl.g:20584:23: (~ ( '\\'' ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20586:17: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* )
            // InternalMyDsl.g:20586:19: '#' (~ ( ( '\\n' | '\\r' ) ) )*
            {
            match('#'); 
            // InternalMyDsl.g:20586:23: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_GH_EXPRESSION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20588:20: ( ( ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* ) ( ( '/' | '.' | '-' | '_' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' )* | ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* )* )
            // InternalMyDsl.g:20588:22: ( ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* ) ( ( '/' | '.' | '-' | '_' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' )* | ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* )*
            {
            // InternalMyDsl.g:20588:22: ( ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalMyDsl.g:20588:23: ( '$' )? '{{' ( options {greedy=false; } : . )* '}}'
                    {
                    // InternalMyDsl.g:20588:23: ( '$' )?
                    int alt3=2;
                    ...
                    // InternalMyDsl.g:20588:33: ( options {greedy=false; } : . )*
                    loop4:
                    do {
                        int alt4=2;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:20588:70: '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
                    {
                    match('$'); 
                    ...
                    // InternalMyDsl.g:20588:98: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
                    loop5:
                    do {
                        int alt5=2;
            ...
            // InternalMyDsl.g:20588:137: ( ( '/' | '.' | '-' | '_' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' )* | ( '$' )? '{{' ( options {greedy=false; } : . )* '}}' | '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* )*
            loop11:
            do {
                int alt11=4;
                switch ( input.LA(1) ) {
                ...
                switch (alt11) {
            	case 1 :
            	    // InternalMyDsl.g:20588:138: ( '/' | '.' | '-' | '_' | '@' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' )*
            	    {
            	    ...
            	    // InternalMyDsl.g:20588:160: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' )*
            	    loop7:
            	    do {
            	        int alt7=2;
            	    ...
            	    break;
            	case 2 :
            	    // InternalMyDsl.g:20588:210: ( '$' )? '{{' ( options {greedy=false; } : . )* '}}'
            	    {
            	    // InternalMyDsl.g:20588:210: ( '$' )?
            	    int alt8=2;
            	    ...
            	    // InternalMyDsl.g:20588:220: ( options {greedy=false; } : . )*
            	    loop9:
            	    do {
            	        int alt9=2;
            	    ...
            	    break;
            	case 3 :
            	    // InternalMyDsl.g:20588:257: '$' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
            	    {
            	    match('$'); 
            	    if ( (input.LA(1)>='A' && input.LA(1)<='Z')||input.LA(1)=='_'||(input.LA(1)>='a' && input.LA(1)<='z') ) {
            	        input.consume();
            	    ...
            	    // InternalMyDsl.g:20588:285: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
            	    loop10:
            	    do {
            	        int alt10=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20590:10: ( ( '0' .. '9' )+ )
            // InternalMyDsl.g:20590:12: ( '0' .. '9' )+
            {
            // InternalMyDsl.g:20590:12: ( '0' .. '9' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_YAML_SCALAR() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20592:18: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' | '/' | '@' | '*' | '$' | '=' | '+' | '<' | '>' | '|' | '&' | '~' | '!' | '?' | '\\\\' | '(' | ')' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' | '*' | '$' | '=' | '+' | '<' | '>' | '|' | '&' | '~' | '!' | '?' | '\\\\' | '(' | ')' | ' ' )* )
            // InternalMyDsl.g:20592:20: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '.' | '/' | '@' | '*' | '$' | '=' | '+' | '<' | '>' | '|' | '&' | '~' | '!' | '?' | '\\\\' | '(' | ')' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' | '*' | '$' | '=' | '+' | '<' | '>' | '|' | '&' | '~' | '!' | '?' | '\\\\' | '(' | ')' | ' ' )*
            {
            ...
            // InternalMyDsl.g:20592:122: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | '.' | '/' | '@' | '*' | '$' | '=' | '+' | '<' | '>' | '|' | '&' | '~' | '!' | '?' | '\\\\' | '(' | ')' | ' ' )*
            loop13:
            do {
                int alt13=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20594:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMyDsl.g:20594:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMyDsl.g:20594:11: ( '^' )?
            int alt14=2;
            ...
            // InternalMyDsl.g:20594:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20596:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMyDsl.g:20596:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMyDsl.g:20596:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalMyDsl.g:20596:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMyDsl.g:20596:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop16:
                    do {
                        int alt16=3;
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:20596:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMyDsl.g:20596:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop17:
                    do {
                        int alt17=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20598:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMyDsl.g:20598:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMyDsl.g:20598:24: ( options {greedy=false; } : . )*
            loop19:
            do {
                int alt19=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20600:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMyDsl.g:20600:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMyDsl.g:20600:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt20=0;
            loop20:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMyDsl.g:20602:16: ( . )
            // InternalMyDsl.g:20602:18: .
            {
            matchAny(); 
    ...
    static final String DFA21_minS =
        "\1\0\2\60\2\40\6\uffff\1\173\1\uffff\2\60\1\55\7\60\1\55\5\60\1\0\1\uffff\1\101\1\40\1\60\1\101\1\52\1\0\3\uffff\4\60\1\uffff\2\60\2\40\1\uffff\2\40\12\uffff\3\60\1\40\1\60\1\40\5\60\1\143\27\60\1\166\5\60\2\40\5\60\1\0\1\uffff\1\0\1\uffff\1\40\1\uffff\1\40\1\uffff\1\0\2\uffff\6\60\4\uffff\3\60\1\uffff\1\60\1\uffff\1\40\5\60\1\157\1\55\13\60\1\40\17\60\1\40\1\60\1\145\2\60\1\55\4\60\1\164\2\uffff\2\60\1\40\2\60\2\0\1\uffff\3\40\1\101\2\0\1\uffff\3\40\2\60\1\55\1\40\1\60\1\55\1\60\1\uffff\3\60\1\40\3\60\1\155\1\143\3\60\1\40\1\60\1\40\1\55\5\60\1\uffff\15\60\1\40\2\60\1\55\1\uffff\1\55\1\162\2\60\1\160\4\60\1\157\2\60\1\uffff\1\40\1\60\5\40\1\0\2\uffff\1\40\1\uffff\1\60\1\40\1\146\1\uffff\1\40\1\166\6\60\1\uffff\1\60\1\40\1\60\1\160\1\157\3\60\1\uffff\1\60\1\uffff\1\60\1\162\1\40\1\60\1\40\5\60\1\55\5\60\2\40\3\60\1\uffff\2\60\1\157\1\166\1\163\2\60\1\141\4\60\1\153\2\40\1\uffff\1\60\2\40\1\uffff\1\60\1\uffff\1\141\1\uffff\1\145\6\60\1\55\1\uffff\1\40\1\151\1\155\5\60\1\145\1\uffff\1\60\1\uffff\1\55\2\60\1\40\1\60\1\164\5\60\2\uffff\5\60\1\156\1\145\1\151\1\60\1\40\1\162\3\40\1\60\1\145\2\uffff\1\60\2\40\1\55\1\163\1\162\1\40\5\60\1\151\1\uffff\1\154\1\160\1\40\1\60\1\40\2\60\1\161\1\60\1\166\1\60\1\40\1\uffff\2\60\1\171\1\60\1\40\5\60\1\55\1\40\1\60\1\40\1\162\1\157\1\60\1\uffff\1\141\3\uffff\1\40\1\156\1\40\1\155\1\164\1\163\1\uffff\1\60\1\40\1\60\1\55\1\60\1\156\1\145\1\151\