...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getJobAccess().getPermissionsAssignment_3_5_2(), "rule__Job__PermissionsAssignment_3_5_2");
			...
			builder.put(grammarAccess.getStepAccess().getWithAssignment_3_7_2_1(), "rule__Step__WithAssignment_3_7_2_1");
			builder.put(grammarAccess.getStepAccess().getEnvAssignment_3_8_2_1(), "rule__Step__EnvAssignment_3_8_2_1");
