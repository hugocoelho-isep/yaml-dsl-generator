...
/**
 * This is the item provider adapter for a {@link pt.isep.yamldslgen.github_actions.MatrixParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MatrixParameterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MatrixParameter_key_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MatrixParameter_key_feature",
								"_UI_MatrixParameter_type"),
						YamlmdePackage.Literals.MATRIX_PARAMETER__KEY, true, false, false,
	...
	protected void addValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_MatrixParameter_values_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_MatrixParameter_values_feature",
								"_UI_MatrixParameter_type"),
						YamlmdePackage.Literals.MATRIX_PARAMETER__VALUES, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((MatrixParameter) object).getKey();
	...
	public void notifyChanged(Notification notification) {
		...
		case YamlmdePackage.MATRIX_PARAMETER__KEY:
		case YamlmdePackage.MATRIX_PARAMETER__VALUES:
