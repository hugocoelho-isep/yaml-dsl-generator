...
/**
 * This is the item provider adapter for a {@link pt.isep.yamldslgen.github_actions.Exclude} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExcludeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addOsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Exclude_os_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Exclude_os_feature", "_UI_Exclude_type"),
						YamlmdePackage.Literals.EXCLUDE__OS, true, false, false,
	...
	protected void addCCompilerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Exclude_cCompiler_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Exclude_cCompiler_feature",
								"_UI_Exclude_type"),
						YamlmdePackage.Literals.EXCLUDE__CCOMPILER, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		String label = ((Exclude) object).getOs();
		return label == null || label.length() == 0 ? getString("_UI_Exclude_type")
